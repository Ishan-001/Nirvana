...
import com.music.nirvana.fragments.HomeFragment
import com.music.nirvana.fragments.VibeoFragment
...
class PrefActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home.setOnClickListener { replace(HomeFragment(context)) }
        vibes.setOnClickListener { replace(VibeoFragment(context)) }
